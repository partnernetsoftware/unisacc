...
def types():
    ...
    p.call("NEXT").tok({TK_NUM: "DM.n"}, bad("array bound"))
...
def build():
    ...
    p = P("S.din")
    p.branch({1: "S.din1"}, bad("array initialiser"), [("CMPI", "dar", 0)])
    q = P("S.din1")
    ...
    q = P("X.ss1")
    q.a(("COPYW", "ips", "ps"), ("COPYW", "ipe", "pe")).call("LOOKUP").call("NOARR").vpop("ssb").branch({1: "X.ss2"}, bad("struct assignment"), [("CMP", "vb", "ssb")])
    q = P("X.ss2")
    ...
    p = P("UNARY")
    p.tok({"sizeof": "U.szof", E.TK_FNUM: "U.fnum", E.TK_STR: "U.str", "~": "U.cpl", "-": "U.neg", "!": "U.not", "(": "U.par", TK_NUM: "U.num", TK_ID: "U.id", "++": "U.pinc", "--": "U.pdec", "&": "U.amp", "*": "U.deref"}, bad("expression"))
    ...
    q = P("PX.sd")
    emit(q, "push").vpush("vt", "vb", "st1", "rk", "vid", "str").call("NEXT").call("EXPR").expect("]").vpop("vt", "vb", "st1", "rk", "vid", "str")
