...
| parse | 2 | 1 | 5/68 | 36 | 340 | 145 | 类别 > 32（商化键 145 已在 MAXQ 1,024 内；取值 68 已在 MAXV 128 内） |
| irsel | 2 | 1 | 6/70 | 70 | 420 | 414 | 类别 > 32（商化键 414 已在 MAXQ 1,024 内；取值 70 已在 MAXV 128 内） |
| isel | 2 | 2 | 73/2 | 94 | 146 | 138 | 类别 > 32；多头与多字段同时出现尚未验证（取值已在容量内） |
| abi | 3 | 13 | 73/3/2 | 62 | 438 | 144 | 13 个头 > MAXH、类别 > 32（商化键、取值已在容量内） |
| combo | 3 | 15 | 73/3/2 | 94 | 438 | 414 | 15 个头 > MAXH、类别 > 32（商化键、取值已在容量内） |
