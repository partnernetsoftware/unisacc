...
| isel | 2 | 2 | 73/2 | 94 | 146 | 138 | 类别 94 > 62，**规则 93 > MAXR 80**；isel 这张表本身尚未验收（多头加多字段的组合已由 abi 与 capcf 以外的多头合成例覆盖）。已核：商化键、取值在容量内，单元 73 < 128；**组数 69/2，字段 1 超过 62** |
| abi | 3 | 13 | 73/3/2 | 62 | 438 | 144 | 无（已移植，aa521ee；MAXH 16，MAXR 80，MAXCAND 288） |
| combo | 3 | 15 | 73/3/2 | 94 | 438 | 414 | 类别 94 > 62，**规则 93 > MAXR 80**。已核：商化键、取值在容量内，单元 99 < 128；**组数 69/3/2，字段 1 超过 62** |
