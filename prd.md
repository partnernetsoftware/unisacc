...
| irsel | 2 | 1 | 6/70 | 70 | 420 | 414 | 类别 70 > 62，**规则 75 > MAXR 62**。已核：商化键、取值在容量内，单元 75 < 128；**组数 6/69，字段 2 超过 62** |
| isel | 2 | 2 | 73/2 | 94 | 146 | 138 | 类别 94 > 62，**规则 93 > MAXR 62**；多头加多字段尚未验证。已核：商化键、取值在容量内，单元 73 < 128；**组数 69/2，字段 1 超过 62** |
| abi | 3 | 13 | 73/3/2 | 62 | 438 | 144 | 无（已移植，aa521ee；MAXH 16，MAXR 80，MAXCAND 288） |
| combo | 3 | 15 | 73/3/2 | 94 | 438 | 414 | 15 个头 > MAXH，类别 94 > 62，**规则 93 > MAXR 62**。已核：商化键、取值在容量内，单元 99 < 128；**组数 69/3/2，字段 1 超过 62** |
