...
| type | 3 | 1 | 15/19/15 | 16 | 4,275 | 3,150 | 原始键 > 4,096，商化键 > 1,024 |
| parse | 2 | 1 | 5/68 | 36 | 340 | 145 | 类别 36 > 32。其余已核：商化键 145 < 1,024，取值 68 < 128，规则 35 < MAXR 62，单元 34 < MAXU 128 |
| irsel | 2 | 1 | 6/70 | 70 | 420 | 414 | 类别 70 > 32，**规则 75 > MAXR 62**。已核：商化键、取值在容量内，单元 75 < 128 |
| isel | 2 | 2 | 73/2 | 94 | 146 | 138 | 类别 94 > 32，**规则 93 > MAXR 62**；多头加多字段尚未验证。已核：商化键、取值在容量内，单元 73 < 128 |
| abi | 3 | 13 | 73/3/2 | 62 | 438 | 144 | 13 个头 > MAXH，类别 62 > 32，**规则 67 > MAXR 62**。已核：商化键、取值在容量内，单元 50 < 128 |
| combo | 3 | 15 | 73/3/2 | 94 | 438 | 414 | 15 个头 > MAXH，类别 94 > 32，**规则 93 > MAXR 62**。已核：商化键、取值在容量内，单元 99 < 128 |
