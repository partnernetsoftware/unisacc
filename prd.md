...
| `parse` | 前端 · 语法 | `nt(5)×tok(60)` | 300 | 8 | `16` | `y(33)` | — | 13 | 1353 |
| `type` | 前端 · 类型 | `t1(9)×op(19)×t2(9)` | 1539 | 8 | `20` | `y(10)` | — | 17 | 1006 |
| `scope` | 前端 · 作用域 | `ctx(6)×kind(5)` | 30 | 8 | `16` | `y(7)` | — | 19 | 479 |
| `irsel` | 前端 · IR 选择 | `family(5)×flavor(33)` | 165 | 8 | `16` | `y(31)` | — | 11 | 1103 |
| `enc` | 后端 · 编码形式 | `op(43)×os(3)×arch(2)` | 258 | 8 | `16` | `y(5)` | — | 29 | 869 |
| `reloc` | 后端 · 重定位 | `kind(3)×arch(2)` | 6 | 6 | `8` | `y(3)` | — | 37 | 161 |
| `isel` | 后端 · 指令选择 | `op(43)×arch(2)` | 86 | 12+8 | `24→16` | `form(5),symbol(59)` | — | 3 | 2524 |
...
**G-2 type** — TYS(9) × TOPS(19) × TYS(9) → TYS|illegal，**1539 行**

```
TYS  = void i8 i16 i32 i64 ptr arr struct fn      （i16 = short，E-31 补入）
...
TY_SIZE: void=1 i8=1 i16=2 i32=4 其余=8
```
...
| **P-3** `net ≡ gold` 可判定 | **已证明**（全域枚举，2,781 key，0 分歧） | E-5 |
...
| **P-6** `gold ≡ C99` | **本实验不声称**。已九次由实现暴露缺陷（3 次在 gold、6 次在走查器），而 acc 全程满分。外部语料给出可测数字：220 例 pass 132 / wrong 0 / unsupported 87 | E-2 · E-15 · E-16 · **E-30** |
...
| **证据** | `tests/corpus.sh` → `corpus 220   pass 132   wrong 0   unsupported 87   knownfail 1`。首次运行是 `pass 124   wrong 8`，其中 8 个是**真误编译**——通过了 difftest 43/43 的编译器，在别人的代码上错了八次 |
