...
subset `unisacc.c` is written in, and it trails the Python front end: **54 of
our 80 probes, 161 of the corpus's 220**, against 209 for the Python one. It
...
can only shrink — it has gone 31 → 54 and 111 → 161 since it was installed.
...
ANSWERS against the Python front end — 48 agree, 6 disagree for reasons
