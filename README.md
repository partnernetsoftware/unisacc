...
**Where things are:** [ARCHITECTURE.md](ARCHITECTURE.md) maps every file to its role -- the seed (Python, stage 0), the core tables and weights, and the self-iterating C compiler.
