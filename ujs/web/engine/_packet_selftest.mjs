...
const buf = encodeRenderPacket({
  ...
  clouds: [
    { color: [0.5, 0.5, 0.5], count: N, xyz, scale: sc },
    { color: [0.2, 0.8, 1], count: 1, xyz: ship, scale: shipS },
  ],
});
...
console.log("OK_PACKET", { bytes: buf.byteLength, clouds: out.clouds.length, n0: out.clouds[0].count });
