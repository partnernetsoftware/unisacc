...
| Host | `host-browser.js` | WebGL / WebGPU 自适应 |
...
| `meshes.js` | 预置几何 |
| `host-browser.js` | 浏览器 `host_*` |
| `app-asteroid.js` / `app-drone.js` | 游戏核（demo；drone 亦进 ship） |
...
# /uxe/demo/            asteroid
# /uxe/demo/drone/      无人机
# /uxe/ship/            asteroid 发布
# /uxe/ship/drone/      无人机发布
